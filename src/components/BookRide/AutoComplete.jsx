...
export default function AutoComplete({getValues,place,placeHolder,type}) {
  ...
  return (
    <div className='relative'>
      <input title={pickup} ref={inputRef} type={type} key={pickup} defaultValue={pickup} list="pickup" onChange={(e) => { getValues(e.target.value);getPlaces(e.target.value) }} className='z-20 w-full h-10 text-[16px] rounded-lg bg-[#EEEEEE] p-2' placeholder={placeHolder} />
