  ...
  return (
    <div className='backgroundImage h-[calc(100vh-64px)]'>
      <div className='w-full h-full backdrop-blur-[4px] flex justify-center items-center flex-col'>
        <div className='min-w-[320px] w-[22.786458333333332vw] mb-[100px] bg-white p-8 rounded-md'>
          <h1 className='text-2xl font-[400] pb-4'>Login to your Ridesharing account.</h1>
